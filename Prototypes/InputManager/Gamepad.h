...
class GamepadDPad
{
    public:
        ...
        GamepadDPad(UINT32 port);
        GamepadDPad(UINT32 port, UINT32 xAxis, UINT32 yAxis);
        ~GamepadDPad();
    ...
    private:
        DriverStation *ap_ds;
        UINT32 a_port;
        UINT32 a_dPadXAxisNum;
        UINT32 a_dPadYAxisNum;
};
...
class Gamepad : public GenericHID
{
    public:
        ...
        static UINT32 GetButtonNumber(ButtonType button);
        static UINT32 GetAxisNumber(AxisType axis);
        ...
        GamepadDPad::DPadDirection GetDPad();
