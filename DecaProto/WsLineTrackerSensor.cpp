...
//
//  @ Project : Untitled
//  @ File Name : WsLineTrackerSensor.cpp
//  @ Date : 12/14/2010
//  @ Author : 
//
//
...
/**
 * Construst an instance of a WsLineTrackerSensor
 *
 * @param slot The physical slot light sensor  is connected to
 * @param channel The analog channel that the line tracker sensor is connected to
 */
WsLineTrackerSensor::WsLineTrackerSensor(UINT32 slot, UINT32 channel)
{
 ...
 * @param channel The analog channel that the line tracker sensor is connected to
 */
WsLineTrackerSensor::WsLineTrackerSensor(UINT32 channel)
{
    a_analogChannel = new AnalogChannel(channel);
}

/**
 * Destroys an instance of a WsLineTrackerSensor
 *
 */
WsLineTrackerSensor::~WsLineTrackerSensor()
{
 ...
 */
void WsLineTrackerSensor::SetThresholds(INT32 threshold)
{
 ...
 */
void WsLineTrackerSensor::SetThresholds(INT32 lightThreshold, INT32 darkThreshold)
{
 ...
 */
bool WsLineTrackerSensor::SeesLight(void )
{
    bool ret = false;
 ...
 */
bool WsLineTrackerSensor::SeesDark(void )
{
    bool ret = false;
 ...
 */
INT32 WsLineTrackerSensor::Get(void )
{
