...
void processDrive(UINT8 use_deadzone)
{
  ...
  if(Oi_rx1_l_trigger > BUTTON_UP_THRESH)
  {
      left_drive_speed = (left_drive_speed * DRIVE_ANTITURBO_NUM) / DRIVE_ANTITURBO_DENOM;
      right_drive_speed = (right_drive_speed * DRIVE_ANTITURBO_NUM) / DRIVE_ANTITURBO_DENOM;
  }
