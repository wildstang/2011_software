...
*/
WsControllerPolarStick::WsControllerPolarStick(InputManager::AxisIndexT xAxis, InputManager::AxisIndexT yAxis)
{
...
float WsControllerPolarStick::GetX()
{
    ...
    x = ap_inputMgr->GetAxisValue(a_xAxis);
...
float WsControllerPolarStick::GetY()
{
    ...
    y = ap_inputMgr->GetAxisValue(a_yAxis);
...
float WsControllerPolarStick::GetAngle()
{
    ...
    // This is expecting Y to be positive
    angle = calcAngle(y, x);
